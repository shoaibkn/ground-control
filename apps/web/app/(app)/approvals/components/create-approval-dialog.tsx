        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              disabled={isSubmitting}
              className="h-9 w-full cursor-pointer rounded-md border border-border/75 bg-background px-2 py-1.5 text-xs font-medium text-foreground outline-none hover:bg-muted/30"
            >
                ...
                <div className="max-h-[140px] space-y-1 overflow-y-auto rounded-md border bg-input/10 p-2 dark:bg-input/20">
                  {activeOrg.members && activeOrg.members.length > 0 ? (
                    activeOrg.members.map((member: any) => {
                      const isChecked = selectedApprovers.includes(
                        member.userId
                      )
                      return (
                        <button
