    ...
    <article className="prose-invert max-w-none space-y-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-zinc-400">
          By accessing or using the Ground Control web application (the
          &ldquo;Service&rdquo;), operated by Ground Control (&ldquo;we,&rdquo;
        ...
        <p className="text-sm leading-relaxed text-zinc-400">
          ...
          you of material changes by posting the revised Terms on this page.
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-zinc-400">
          Ground Control is a collaborative project management and task tracking
          application. The Service allows users to create organizations, manage
          tasks and approvals, build forms, collaborate in real-time through
          chat threads, attach files, and maintain audit trails of all workspace
          activity.
        </p>
        <p className="text-sm leading-relaxed text-zinc-400">
          The Service is currently offered in Beta. Features, availability, and
      ...
      <section className="space-y-4">
        ...
        <ul className="list-inside list-disc space-y-2 text-sm text-zinc-400">
          ...
          <li>
            Upload, transmit, or distribute any harmful, offensive, or illegal
            content
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-zinc-400">
          If you leave or are removed from an organization, you will lose access
          to that organization&apos;s data. The organization owner may choose to
          retain or delete your contributions.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-inside list-disc space-y-2 text-sm text-zinc-400">
          ...
          <li>
            Data loss may occur during Beta, and we recommend maintaining your
      ...
      <section className="space-y-4">
        ...
        <p className="font-mono text-sm text-[11px] leading-relaxed tracking-wide text-zinc-400 uppercase">
